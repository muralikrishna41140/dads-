  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DadDesk AI — Built for Fathers" },
      {
        ...
        content: "AI-powered personal finance & document assistant for dads.",
      },
    ],
  }),
  component: Landing,
...
const features = [
  {
    icon: Wallet,
    titleKey: "landing.featureExpenseTitle",
    descKey: "landing.featureExpenseDesc",
    to: "/expenses",
  },
  {
    icon: FolderLock,
    titleKey: "landing.featureDocumentsTitle",
    descKey: "landing.featureDocumentsDesc",
    to: "/documents",
  },
  {
    icon: Landmark,
    titleKey: "landing.featureLoansTitle",
    descKey: "landing.featureLoansDesc",
    to: "/loans",
  },
  {
    icon: StickyNote,
    titleKey: "landing.featureNotesTitle",
    descKey: "landing.featureNotesDesc",
    to: "/notes",
  },
] as const;
...
const testimonials = [
  ...
  },
  {
    ...
    quote: "All my EMIs, school fees and documents in one beautiful place. It feels built for me.",
  },
];
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/dashboard">
              <Button className="rounded-full bg-gradient-brand shadow-elegant">
                {t("landing.openDashboard")} <ArrowRight className="ml-1.5 h-4 w-4" />
              </Button>
            </Link>
          </div>
        </div>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-8 lg:py-24">
          ...
          >
            ...
            <h1 className="mt-5 font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="text-gradient-brand">{t("landing.heroTitleHighlight")}</span>{" "}
              <span className="inline-block">❤️</span>
            </h1>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              {t("landing.heroBody")} {t("landing.heroBodyTail")}
            </p>
            ...
            <div className="mt-8 flex items-center gap-6 text-xs text-muted-foreground">
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-success" /> {t("landing.security")}
              </div>
              <div className="flex items-center gap-2">
                <Sparkles className="h-4 w-4 text-primary" /> {t("landing.insights")}
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <div className="text-xs text-muted-foreground">{t("landing.savingLabel")}</div>
            ...
            >
              <div className="flex items-center gap-2 text-xs text-warning">
                <Sparkles className="h-3.5 w-3.5" /> {t("landing.aiInsight")}
              </div>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">{t("landing.modulesBody")}</p>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <h3 className="mt-5 font-display text-lg font-bold">{t(f.titleKey)}</h3>
      ...
      <section id="voices" className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <div className="text-sm font-semibold uppercase tracking-widest text-primary">
            {t("landing.voicesLabel")}
          </div>
          <h2 className="mt-2 font-display text-3xl font-bold sm:text-4xl">
            {t("landing.voicesTitle")}
          </h2>
        </div>
      ...
      <section className="px-4 pb-20 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-gradient-brand p-10 text-white shadow-glow sm:p-16">
          ...
          <div className="relative max-w-2xl">
            ...
            <p className="mt-3 text-white/85">{t("landing.ctaBody")}</p>
            <Link to="/dashboard">
              <Button
                size="lg"
                className="mt-6 rounded-full bg-white px-6 text-primary hover:bg-white/90"
              >
                {t("landing.openDashboard")} <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          </div>
        </div>
      ...
      <footer className="border-t border-border bg-background">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 py-8 sm:px-6 sm:flex-row lg:px-8">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Heart className="h-4 w-4 fill-primary text-primary" /> {t("landing.footerLove")}
          </div>
          <div className="text-xs text-muted-foreground">{t("landing.footerNote")}</div>
        </div>
      </footer>
    </div>
  );
